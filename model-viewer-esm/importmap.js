...
const react = {
    ...
    'react-visibility-sensor': './node_modules/react-visibility-sensor/visibility-sensor.js',
};
const react_min = {
    ...react,
...
const imports = {
    ...playcanvas,
    //'pcui': nodeModules + '@playcanvas/pcui/dist/module/src/index.mjs',
    'pcui': nodeModules + '@playcanvas/pcui/react/dist/module/src/index.mjs',
    ...
    'qrious': importFile("export default QRious;"), // UMD import
    ...react_min
};
